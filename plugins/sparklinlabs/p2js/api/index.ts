...
SupCore.system.api.registerPlugin<SupCore.TypeScriptAPIPlugin>("typescript", "p2", {
  code: "",
  defs: fs.readFileSync(`${__dirname}/p2.d.ts.txt`, { encoding: "utf8" }),
});

SupCore.system.api.registerPlugin<SupCore.TypeScriptAPIPlugin>("typescript", "P2Body", {
